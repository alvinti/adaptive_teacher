...
#             box_features_t = grad_reverse(box_features_t)
...
#             box_features_s_unsup = grad_reverse(box_features_s) #TODO 忘了改box_feature_s！！他妈的！
#             D_img_out_s_ins_unsup = self.D_img_ins(box_features_s_unsup)
#             loss_D_img_s_ins_unsup = F.binary_cross_entropy_with_logits(D_img_out_s_ins_unsup, torch.FloatTensor(D_img_out_t_ins.data.size()).fill_(target_label).to(self.device))
...
#             losses["loss_D_img_t"] = loss_D_img_t + loss_D_img_s_ins_unsup # loss_D_img_t_ins + 
#             # return losses, [], [], None
#             return losses
...
#             # return losses, [], [], None  +loss_D_img_ins
#             return losses
